    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-20 relative">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center justify-center h-20 w-20 rounded-3xl bg-gradient-primary mb-8 shadow-glow">
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <GlassCard className="p-8 text-center" hover>
            <div className="h-16 w-16 mx-auto rounded-2xl bg-gradient-success flex items-center justify-center mb-4">
          ...
          <GlassCard className="p-8 text-center" hover>
            <div className="h-16 w-16 mx-auto rounded-2xl bg-gradient-warning flex items-center justify-center mb-4">
          ...
          <GlassCard className="p-8 text-center" hover>
            <div className="h-16 w-16 mx-auto rounded-2xl bg-gradient-danger flex items-center justify-center mb-4">
